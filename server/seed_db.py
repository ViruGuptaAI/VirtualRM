...
def seed_data(cur: sqlite3.Cursor):
    ...
    customers = [
        ...
        ('rajesh', 'Rajesh Kumar', 'rajesh.kumar@email.com', '+91-98765-43210', 'ABCPK1234A', '4521', '1985-03-15', 'Male', '42, MG Road, Koramangala', 'Bengaluru', 'Karnataka', '560034', 'Completed', 'Premium', '2018-06-10', 782, 125000, 1, 0, 5),
    ...
    # ── Savings Accounts ───────────────────────────────────────────────
    accounts = [
        ('rajesh', '5968-6484-4521', 'Premium Savings', 485230, 4.5, 25000, 'CTSO0001234', 'Registered', '2018-06-10'),
    ...
    # ── Credit Cards ───────────────────────────────────────────────────
    credit_cards = [
        ('rajesh', '7842', 'Platinum', 300000, 215000, 85000, 4250, 15, 12450, 1500, 'Waived if spend > ₹3L', 3.5, 'Active', '2019-02-01'),
    ...
    # ── Loans ──────────────────────────────────────────────────────────
    loans = [
        ('rajesh', 'HL-2024-78542', 'Home Loan', 4500000, 4280000, 39200, 8.90, 360, 324, '2024-01-15', 'Active'),
        ('rajesh', 'PL-2025-12087', 'Personal Loan', 500000, 320000, 11500, 11.50, 60, 30, '2025-01-10', 'Active'),
    ...
    # ── Pre-approved Offers ────────────────────────────────────────────
    offers = [
        ('rajesh', 'Personal Loan', 800000, 10.75, 'Instant disbursement, minimal documentation', '2026-12-31'),
        ('rajesh', 'Top-up Home Loan', 500000, 9.10, 'Top-up on existing HL-2024-78542', '2026-12-31'),
        ...
        ('amit', 'Personal Loan', 400000, 10.5, 'Instant approval for salary account holders', '2026-12-31'),
    ...
    loan_products = [
        ...
        ('Home Loan',       500000,  50000000, 8.25, 10.50, 8.90, 75, 200, 12, 360, 0.5, 0, 2.0, 0.80, 1, 'Property as collateral; CIBIL 700+ for best rate'),
    ...
    # ── Fixed Deposits ─────────────────────────────────────────────────
    fds = [
        ('rajesh', 'FD-2025-3318', 500000, 7.1, 24, '2025-03-15', '2027-03-15', 0, 1),
        ('rajesh', 'FD-2024-8891', 200000, 6.8, 12, '2025-09-01', '2026-09-01', 0, 1),
    ...
    # ── Recurring Deposits ─────────────────────────────────────────────
    rds = [
        ('rajesh', 'RD-2025-1102', 10000, 6.5, 30, '2025-07-01', '2028-01-01', 105000),
    ...
    # ── Debit Cards ────────────────────────────────────────────────────
    debit_cards = [
        ('rajesh', '4521', 'Visa', 'Platinum', 100000, 1, 'Active'),
    ...
    # ── Investments ────────────────────────────────────────────────────
    investments = [
        ('rajesh', 'Mutual Fund', 'HDFC Flexi Cap Fund', 324500, 280000, 15.9, 10000, 5),
        ('rajesh', 'PPF', 'Public Provident Fund', 620000, 560000, 7.1, None, None),
    ...
    txns = [
        # Rajesh
        ('rajesh', 'savings', '2026-05-28', 'Amazon India', 4299, 'debit', 'shopping', 485230),
        ('rajesh', 'savings', '2026-05-27', 'Salary Credit - TCS', 125000, 'credit', 'salary', 489529),
        ('rajesh', 'savings', '2026-05-27', 'Swiggy', 856, 'debit', 'food', 364529),
        ('rajesh', 'savings', '2026-05-26', 'Electricity Bill - BESCOM', 2340, 'debit', 'utility', 365385),
        ('rajesh', 'savings', '2026-05-25', 'UPI - Priya S.', 5000, 'debit', 'transfer', 367725),
        ('rajesh', 'savings', '2026-05-23', 'RD Installment', 10000, 'debit', 'investment', 372725),
        ('rajesh', 'savings', '2026-05-20', 'NEFT - Rent', 35000, 'debit', 'transfer', 382725),
        ('rajesh', 'savings', '2026-05-18', 'ATM Withdrawal', 10000, 'debit', 'cash', 417725),
        ('rajesh', 'credit_card', '2026-05-22', 'Amazon.in', 12500, 'debit', 'shopping', None),
        ('rajesh', 'credit_card', '2026-05-20', 'Swiggy', 850, 'debit', 'food', None),
        ('rajesh', 'credit_card', '2026-05-18', 'Reliance Fuel', 3200, 'debit', 'fuel', None),
        ('rajesh', 'credit_card', '2026-05-15', 'BigBasket', 2100, 'debit', 'shopping', None),
        ('rajesh', 'credit_card', '2026-05-12', 'PVR Cinemas', 1400, 'debit', 'entertainment', None),
        # Priya
